  ...
  return (
    <section className="px-[5%] pb-24 pt-12">
      <div className="relative group">
        ...
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#0d0f1a] via-[#1a1f3a] to-[#0d0f1a] rounded-3xl opacity-95 transition-opacity duration-300"></div>
        ...
        <div className="relative z-10 py-20 px-12 text-center max-w-3xl mx-auto">
          ...
          <p className="text-gray-300 mb-12 text-lg leading-relaxed max-w-2xl mx-auto group-hover:text-gray-200 transition-colors duration-300">
            Join practical internship and bootcamp programs designed to help
            students gain real-world experience, build strong portfolios, and
