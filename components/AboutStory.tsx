        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-muted">
              ...
              <p>
                That&apos;s why we built ZeroTwoCode. We believe the best way to learn software engineering is by actually building software. Not toy projects, but real products with real users.
              </p>
              <p>
