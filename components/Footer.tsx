  ...
  return (
    <footer className="bg-background border-t border-border py-16 px-[5%]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
        {/* Brand Section */}
        <div>
          <div className="font-bold text-lg text-foreground mb-3">ZeroTwoCode</div>
          ...
          <div className="flex gap-3">
            <a href="#" className="w-8 h-8 rounded-lg bg-card border border-border flex items-center justify-center text-sm text-muted hover:border-accent transition-colors">
              𝕏
            </a>
            <a href="#" className="w-8 h-8 rounded-lg bg-card border border-border flex items-center justify-center text-sm text-muted hover:border-accent transition-colors">
              in
        ...
        <div>
          ...
          <ul className="space-y-2">
            {['Summer Internship', 'Winter Internship', 'Apprenticeship', 'AI Bootcamp'].map((item) => (
              <li key={item}>
        ...
        <div>
          ...
          <ul className="space-y-2">
            {['About Us', 'Student Projects', 'Mentors', 'Careers'].map((item) => (
              <li key={item}>
                <a href="#" className="text-xs text-muted hover:text-foreground transition-colors">
                  {item}
                </a>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="mailto:hello@zerotwocode.com" className="text-xs text-muted hover:text-foreground transition-colors flex items-center gap-2">
                <Mail className="h-3 w-3" />
                hello@zerotwocode.com
              </a>
            </li>
            <li>
              <a href="tel:+15550000000" className="text-xs text-muted hover:text-foreground transition-colors flex items-center gap-2">
